...
const Hero = ({trending}: HomeProps): JSX.Element => {
  ...
  return (
    <div className='flex flex-col space-y-2 py-23 md:space-y-4 lg:h-[65vh] lg:pb-12 lg:justify-end'>
      ...
      <div>
      <button className='bg-transparent border-solid border-2 w-[200px] h-[56px] rounded-full'>Watch Now</button>
      </div>
